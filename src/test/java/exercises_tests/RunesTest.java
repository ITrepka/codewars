...
import exercises.Runes;
import org.junit.Test;

public class RunesTest {
    @Test
    public void testSample() {
        assertEquals( "Answer for expression '-?56373--9216=-?47157' " , 8 , Runes.solveExpression("-?56373--9216=-?47157") );
        ...
        assertEquals( "Answer for expression '-??--1=-??' " , -1 , Runes.solveExpression("-??--1=-??") );
